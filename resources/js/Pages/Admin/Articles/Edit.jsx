...
export default function ArticleEdit({ article }) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        category: article.category || 'PC',
        publisher: article.publisher || 'Playscore',
        publisher_logo: article.publisher_logo || 'P',
        publisher_bg: article.publisher_bg || 'bg-[#22C55E]',
        author: article.author || '',
        read_time: article.read_time || '5 min read',
        sources: article.sources || (article.source_url ? [{ name: article.source_name || 'Original Source', url: article.source_url }] : [{ name: '', url: '' }]),
        tags: article.tags || ['#Gaming', '#News'],
    ...
    return (
        <AppLayout>
            <Head title={`Edit Article: ${article.title} - Admin`} />
            ...
            <div className="py-4 sm:py-6 space-y-6">
                ...
                <div className="border-b border-[#1F2923] pb-6">
                    ...
                    <nav className="flex items-center gap-1.5 text-xs text-[#8B948F] mt-2 font-medium">
                        ...
                        <span>/</span>
                        <span className="text-[#F5F7F5]">Edit Blog & Articles</span>
                    </nav>
                </div>
                    ...
                    >
                        ...
                        <div className="bg-[#131916] border border-[#1F2923] p-4 rounded-2xl space-y-3">
                            ...
                            <button
                                type="submit"
                                disabled={processing}
                                className="w-full py-2.5 rounded-xl bg-[#22C55E] text-[#0B0F0D] font-bold text-xs hover:bg-[#4ADE80] transition shadow-md shadow-[#22C55E]/20"
                            >
