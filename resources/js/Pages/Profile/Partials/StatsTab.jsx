...
export default function StatsTab({ stats, myReviews = [], onSelectTab, showDownload = true }) {
    const {
        totalReviews = 0,
        totalGamesInList = 0,
        averageScore = 0,
            ...
            {showDownload && (
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4 bg-[#131916] border border-[#1F2923] rounded-xl p-4 sm:p-5">
                    ...
                    <button
                        ...
                        className="w-full sm:w-auto justify-center rounded-lg bg-[#22C55E] hover:bg-[#16A34A] text-[#0B0F0D] font-bold px-3.5 sm:px-4 py-2 text-xs sm:text-sm flex items-center gap-1.5 transition shadow-sm shrink-0"
                    >
                        <svg
